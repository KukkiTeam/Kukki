...
public class NewFeedItems {
    int id;
    String title, artist, time_finish, total_like, total_comment, total_view, total_kcal, feedImage, isLike;

    public NewFeedItems() {
    }

    public NewFeedItems(int id, String title, String artist, String time_finish, String total_like, String total_comment, String total_view, String total_kcal, String feedImage, String isLike) {
        this.id = id;
        this.title = title;
        this.artist = artist;
